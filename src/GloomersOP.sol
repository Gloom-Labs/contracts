...
contract Gloomers is ERC721AOffsetable, Ownable {
    ...
    uint256 public immutable randomSeed = 3333; // temp while using foundry
    ...
    constructor() ERC721AOffsetable("Gloomers", "GLOOMERS", 1) Ownable(msg.sender) {
    ...
    function nextTokenId() public view returns (uint256) {
        return (_nextTokenId() + _startTokenId()) % (MAX_SUPPLY);
    }
